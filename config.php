...
$config['website-name'] = "Proxy - Free Anonymous Web Proxy";
$config['website-url'] = "http://" . $_SERVER['HTTP_HOST'] . "/PHP-Web-Proxy";
$config['website-description'] = "Proxy - Free Anonymous Web Proxy to Bypass Block Restrictions.";

// a unique key that identifies this application - DO NOT LEAVE THIS EMPTY!
$config['app_key'] = '04e8155d1ddc8d00c578a7ffc0018693';
...
$config['error_redirect'] = "http://" . $_SERVER['HTTP_HOST'] . "/PHP-Web-Proxy/error";
//$config['index_redirect'] = "https://" . $_SERVER['HTTP_HOST'] . "/";
